...
class TestModelValidator:
    ...
    def test_missing_required_fields(self):
        ...
        assert result.is_valid is False
        assert any("Missing required field: provider" in error for error in result.errors)
    ...
    def test_invalid_temperature(self):
        ...
        assert result.is_valid is False
        assert any("Temperature must be a number between 0 and 2" in error for error in result.errors)
    ...
    def test_invalid_max_tokens(self):
        ...
        assert result.is_valid is False
        assert any("max_tokens must be a positive integer" in error for error in result.errors)
...
class TestValidationEngine:
    ...
    def test_validate_input_parameters(self):
        ...
        result = self.engine.validate_input_parameters(parameters, required_params, param_types)
    ...
    def test_validate_input_parameters_missing_required(self):
        ...
        assert result.is_valid is False
        assert any("Missing required parameter: name" in error for error in result.errors)
    ...
    def test_validate_input_parameters_wrong_type(self):
        ...
        result = self.engine.validate_input_parameters(parameters, param_types=param_types)
...
class TestValidationDecorator:
    ...
    def test_validate_inputs_decorator_success(self):
        ...
        @validate_inputs(required_params=["name"], param_types={"name": str, "age": int})
