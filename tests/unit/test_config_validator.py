...
class TestConfigurationValidator:
    ...
    def test_validator_initialization(self):
        ...
        with patch(
            "equitrcoder.core.config_validator.get_config_manager"
        ) as mock_get_config:
    ...
    def test_model_configuration_validation_missing_model(self):
        ...
        config_without_model = {
            "llm": {"provider": "litellm", "temperature": 0.1},
            "orchestrator": {"supervisor_model": "o3", "worker_model": "gpt-4"},
        }
    ...
    def test_hot_reloading_capability(self):
        ...
        with patch(
            ...
            mock_config_manager.validate_schema.return_value = MagicMock(
    ...
    def test_global_functions(self):
        ...
        with patch(
            "equitrcoder.core.config_validator.ConfigurationValidator"
