...
class TestPerformanceMetrics:
    ...
    def test_metrics_creation(self):
        ...
        metrics = PerformanceMetrics(
            operation_name="test_operation", duration_ms=100.5, memory_usage_mb=50.2
        )
...
class TestPerformanceBaseline:
    ...
    def test_baseline_update(self):
        ...
        new_metrics = PerformanceMetrics(
            operation_name="test_op", duration_ms=200.0, memory_usage_mb=100.0
        )
...
class TestPerformanceProfiler:
    ...
    def test_get_operation_stats(self):
        ...
        metrics1 = PerformanceMetrics(
            operation_name="test_op", duration_ms=100.0, memory_usage_mb=50.0
        )
        metrics2 = PerformanceMetrics(
            operation_name="test_op", duration_ms=200.0, memory_usage_mb=75.0
        )
    ...
    def test_identify_bottlenecks(self):
        ...
        slow_metrics = PerformanceMetrics(
            operation_name="slow_op", duration_ms=2500.0
        )  # > 2x threshold for critical
...
class TestPerformanceOptimizationEngine:
    ...
    def test_engine_initialization(self):
        ...
        engine = PerformanceOptimizationEngine(
            enable_memory_profiling=True, enable_performance_profiling=True
        )
    ...
    def test_engine_disabled_profiling(self):
        ...
        engine = PerformanceOptimizationEngine(
            enable_memory_profiling=False, enable_performance_profiling=False
        )
    ...
    def test_monitor_operation(self, mock_thread_count, mock_cpu):
        ...
        with patch.object(
            engine.performance_profiler,
            "_get_memory_usage",
            return_value=(100.0, 120.0),
        ):
    ...
    def test_alert_generation(self):
        ...
        slow_metrics = PerformanceMetrics(
            operation_name="slow_op", duration_ms=200.0  # Exceeds 100ms threshold
        )
...
class TestGlobalFunctions:
    ...
    def test_configure_performance_engine(self):
        ...
        engine = configure_performance_engine(
            enable_memory_profiling=False, alert_thresholds={"duration_ms": 2000.0}
        )
