...
class ModelManager:
    ...
    async def validate_model(self, model: str, test_call: bool = False) -> ModelValidationResult:
    ...
    def estimate_cost(self, model: str, prompt_tokens: int, completion_tokens: int) -> CostEstimate:
    ...
    def format_model_error(self, model: str, validation_result: ModelValidationResult) -> str:
        ...
        if validation_result.availability_status == "api_key_missing":
            ...
            instruction = setup_instructions.get(provider, f"Get your API key from the {provider} provider")
