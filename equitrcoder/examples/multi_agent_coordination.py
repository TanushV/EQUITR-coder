...
async def security_isolation_example():
    ...
    print(f"  Can access config/default.yaml: {secure_worker.can_access_file('equitrcoder/config/default.yaml')}")
    print(f"  Can access core/orchestrator.py: {secure_worker.can_access_file('equitrcoder/core/orchestrator.py')}")
    ...
    print(f"  Can access examples/README.md: {general_worker.can_access_file('equitrcoder/examples/README.md')}")
    print(f"  Can access config/default.yaml: {general_worker.can_access_file('equitrcoder/config/default.yaml')}")
...
async def complex_workflow_example():
    ...
    print(f"   Success rate: {(sum(1 for r in analysis_results + phase2_results if r.success) / len(analysis_results + phase2_results)) * 100:.1f}%")
