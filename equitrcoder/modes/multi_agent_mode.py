...
from ..tools.builtin.todo import set_global_todo_file, TodoManager
...
class MultiAgentMode:
    ...
    def __init__(
        ...
        print(f"🎭 Multi-Agent Mode ({num_agents} agents, {'parallel' if run_parallel else 'sequential'}):")
    ...
    async def run(
        ...
        try:
            ...
            print(f"✅ Documentation created for {self.num_agents} agents: {docs_result['task_name']}")
...
Start by using list_todos to see your assigned work!"""
            ...
            return {
                ...
                "audit_results": [result.get("audit_result", {}) for result in agent_results]
            }
